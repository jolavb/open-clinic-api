...
RSpec.describe StudiesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new study" do

        post :create, params: {study: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(study_url(Study.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the study" do
        study = Study.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the study" do
        study = Study.create! valid_attributes
